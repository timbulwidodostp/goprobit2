...
{title:Examples}
    ...
    {hline}
{pstd}Setup{p_end}
{phang2}{cmd:. import excel "https://raw.githubusercontent.com/timbulwidodostp/goprobit2/main/goprobit2/goprobit2.xlsx", sheet("Sheet1") firstrow clear}{p_end}

{pstd}Ordered response regression with Skewed Generalized t CDF link function{p_end}
{phang2}{cmd:. goprobit2 goprobit2 goprobit2_1 goprobit2_2 goprobit2_3, dist(sgt)}{p_end}
...
{phang}Timbul Widodo{p_end}
{phang}Universitas Semarang (USM){p_end}
{phang}Olah Data Semarang{p_end}
{phang}www.youtube.com/@amalsedekah{p_end}
